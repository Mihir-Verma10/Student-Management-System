...
<h1 style="position:absolute;top:190px;left:150;color:black;left:200px">USER ID</h1>
<input type="text" name="user_id" placeholder="enter your user id here"style="position:absolute;top:260px;left:200px;height:35px;width:400px;border-width:2px" required>
