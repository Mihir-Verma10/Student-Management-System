...
<form method="POST">
<h1 style="position:absolute;top:50px;left:300px;font-family:'algerian';color:black">pay fees for dcs students</h1>
...
{
$query="select * from pgdca where name='$name' and email='$email';";
$q=mysqli_query($conn,$query);
$num=mysqli_num_rows($q);
if($num==1)
{
	$q1="update pgdca set remaining_fees=(remaining_fees-$amount) where name='$name' and email='$email';";
